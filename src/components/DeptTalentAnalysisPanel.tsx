...
export const DeptTalentAnalysisPanel: React.FC<Props> = ({ talents, lang, selectedDept, onDeptChange, isLdMode = false }) => {
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm space-y-4 flex flex-col w-full h-full lg:min-h-[460px] select-none" id="dept-analysis-component">
      <div>
