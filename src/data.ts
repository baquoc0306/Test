...
export const dbTalentPool: Talent[] = [
  ...
  { name: "Edgar Bui", cell: "Superstar", results: "High Effective", potential: "High", group: "Growers", dept: "TAT Quality", site: "MLN" },
...
export const initialPipelinePositions: Omit<PipelinePosition, 'pipeline'>[] = [
  ...
  { id: 81, incumbent: "Edgar Bui", dept: "TAT Quality", role: "TAT Manager", risk: "Medium", status: "Successor in Development", interim: "None", successor: "Yes hire", readiness: "1-2 Years", site: "MLN" },
