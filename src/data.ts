...
export const ashTalentPool: Talent[] = [
  ...
  { name: "Lona Nguyen (HR)", cell: "Valued Contributor", results: "Effective", potential: "Mid", group: "Keepers", dept: "CUSTOMS", site: "ASH" },
  ...
  { name: "Lona Nguyen (CS)", cell: "Valued Contributor", results: "Effective", potential: "Mid", group: "Keepers", dept: "HUMAN RESOURCES", site: "ASH" },
  // CUSTOMER SERVICE
...
export const dbTalentPool: Talent[] = [
  ...
  { name: "Nguyen Thi Mong Van", cell: "Seasoned Professional", results: "High Effective", potential: "Low", group: "Keepers", dept: "Warehouse/C&S", site: "WNK" },
  { name: "Truong Minh Hung", cell: "Valued Contributor", results: "Effective", potential: "Mid", group: "Keepers", dept: "Warehouse/C&S", site: "WNK" },
  { name: "Harvey Nguyen", cell: "High Professional", results: "High Effective", potential: "Mid", group: "Growers", dept: "TAT Quality", site: "WNK" },
  ...
  { name: "Anna Tran", cell: "Rising Star", results: "Effective", potential: "High", group: "Growers", dept: "Plant Engineering", site: "WNK" },
  { name: "Le Thi Huong", cell: "Seasoned Professional", results: "High Effective", potential: "Low", group: "Keepers", dept: "Production", site: "WNK" },
  { name: "Nguyen Hai Trieu", cell: "High Professional", results: "High Effective", potential: "Mid", group: "Growers", dept: "Production", site: "WNK" },
  { name: "Truong Thi Thuy Trang", cell: "Seasoned Professional", results: "High Effective", potential: "Low", group: "Keepers", dept: "Production", site: "WNK" },
  { name: "Le Thi Tuyen", cell: "High Professional", results: "High Effective", potential: "Mid", group: "Growers", dept: "Production", site: "WNK" },
  { name: "Trinh Thi Kim Loan", cell: "Seasoned Professional", results: "High Effective", potential: "Low", group: "Keepers", dept: "Production", site: "WNK" },
  { name: "Nguyen Phuoc Duy", cell: "High Professional", results: "High Effective", potential: "Mid", group: "Growers", dept: "Production", site: "WNK" },
  { name: "Phan Thanh Son", cell: "Valued Contributor", results: "Effective", potential: "Mid", group: "Keepers", dept: "Production", site: "WNK" },
  { name: "Le Tuan Anh", cell: "Valued Contributor", results: "Effective", potential: "Mid", group: "Keepers", dept: "Production", site: "WNK" },
  { name: "Daniel Pham", cell: "Superstar", results: "High Effective", potential: "High", group: "Growers", dept: "IT", site: "WNK" },
  { name: "Huynh Van Nhat", cell: "Seasoned Professional", results: "High Effective", potential: "Low", group: "Keepers", dept: "Production/Management", site: "WNK" },
  { name: "Tran Minh Thuan", cell: "High Professional", results: "High Effective", potential: "Mid", group: "Growers", dept: "Production/Management", site: "WNK" },
  { name: "Duong Tri Dung", cell: "High Professional", results: "High Effective", potential: "Mid", group: "Growers", dept: "Production/Management", site: "WNK" },
  { name: "Ly Thanh Tung", cell: "Solid Professional", results: "Effective", potential: "Low", group: "Keepers", dept: "Production/Management", site: "WNK" },
  { name: "Tong Thi Sang", cell: "Valued Contributor", results: "Effective", potential: "Mid", group: "Keepers", dept: "Production/Management", site: "WNK" },
  { name: "Mai Hai Long", cell: "High Professional", results: "High Effective", potential: "Mid", group: "Growers", dept: "Production/UPH", site: "WNK" },
  { name: "Dang Van Tan", cell: "Valued Contributor", results: "Effective", potential: "Mid", group: "Keepers", dept: "Production/UPH", site: "WNK" },
  { name: "Ngo Huu Chi", cell: "Valued Contributor", results: "Effective", potential: "Mid", group: "Keepers", dept: "Production/UPH", site: "WNK" },
  { name: "Pham Dinh Tung", cell: "High Professional", results: "High Effective", potential: "Mid", group: "Growers", dept: "Production/C&S", site: "WNK" },
  { name: "Thuy Do", cell: "Valued Contributor", results: "Effective", potential: "Mid", group: "Keepers", dept: "Production/C&S", site: "WNK" },
  { name: "Bui Van Thap", cell: "Rising Star", results: "Effective", potential: "High", group: "Growers", dept: "Production/C&S", site: "WNK" },
  { name: "Vo Chi Tinh", cell: "Valued Contributor", results: "Effective", potential: "Mid", group: "Keepers", dept: "Production/C&S", site: "WNK" },
  ...
  { name: "Mai Thi Loan", cell: "Solid Professional", results: "Effective", potential: "Low", group: "Keepers", dept: "Production/C&S", site: "WNK" },
  { name: "Do Thi Thanh Nga", cell: "Solid Professional", results: "Effective", potential: "Low", group: "Keepers", dept: "Production/C&S", site: "WNK" },
  { name: "Elsa Nguyen", cell: "Valued Contributor", results: "Effective", potential: "Mid", group: "Keepers", dept: "Production/C&S", site: "WNK" },
  { name: "Mai Thi Hoang Bich Tram", cell: "Rising Star", results: "Effective", potential: "High", group: "Growers", dept: "Production/C&S", site: "WNK" },
  ...
  { name: "Vu Van Xuan", cell: "High Professional", results: "High Effective", potential: "Mid", group: "Growers", dept: "Production", site: "WNK" },
  { name: "Giap Quang Huy", cell: "Valued Contributor", results: "Effective", potential: "Mid", group: "Keepers", dept: "Production", site: "WNK" },
  { name: "Dinh Thi Hong Van", cell: "Valued Contributor", results: "Effective", potential: "Mid", group: "Keepers", dept: "Production", site: "WNK" },
  { name: "Trinh Ngoc Phien", cell: "Rising Star", results: "Effective", potential: "High", group: "Growers", dept: "Production", site: "WNK" },
  // ── ASHTON (ASH) ──────────────────────────────────────────
  ...ashTalentPool,
];
...
export const initialPipelinePositions: Omit<PipelinePosition, 'pipeline'>[] = [
  ...
  { id: 78, incumbent: "Nguyen Thi Mong Van", dept: "Warehouse/C&S", role: "Material Delivery Lead Supervisor", risk: "Medium", status: "Successor in Development", interim: "Sang Tong", successor: "Thao Phan / Robert Pham", readiness: "1-2 Years", site: "WNK" },
  { id: 79, incumbent: "Truong Minh Hung", dept: "Warehouse/C&S", role: "Material Delivery Lead Supervisor", risk: "Medium", status: "Successor in Development", interim: "Sang Tong", successor: "Hien Nguyen", readiness: "1-2 Years", site: "WNK" },
  { id: 80, incumbent: "Harvey Nguyen", dept: "TAT Quality", role: "TAT Manager", risk: "Medium", status: "Successor in Development", interim: "None", successor: "Trina", readiness: "1-2 Years", site: "WNK" },
  ...
  { id: 85, incumbent: "Chivas Cao", dept: "IT", role: "Manager", risk: "Medium", status: "No Successor Identified", interim: "None", successor: "None", readiness: "None", site: "WNK" },
  ...
  { id: 94, incumbent: "Anna Tran", dept: "Plant Engineering", role: "MRO Assistant Manager", risk: "Medium", status: "Interim Coverage Only", interim: "Louis Le / Thanh Nguyen", successor: "None", readiness: "None", site: "WNK" },
  { id: 95, incumbent: "Nguyen Phuoc Duy", dept: "Production", role: "Production Lead Supervisor - UPH Support", risk: "High", status: "Successor in Development", interim: "T Anh", successor: "Ms Thành", readiness: "< 1 Year", site: "WNK" },
  { id: 96, incumbent: "Truong Thi Thuy Trang", dept: "Production", role: "Production Lead Supervisor - UPH Support", risk: "High", status: "Successor in Development", interim: "H - Triều", successor: "Ms Thành", readiness: "< 1 Year", site: "WNK" },
  { id: 97, incumbent: "Nguyen Hai Trieu", dept: "Production", role: "QC Lead Supervisor - UPH QC", risk: "High", status: "Successor in Development", interim: "P - Duy", successor: "Mr Khanh", readiness: "< 1 Year", site: "WNK" },
  { id: 98, incumbent: "Le Tuan Anh", dept: "Production", role: "Production Lead Supervisor - UPH Assembly", risk: "Medium", status: "Ready Successor Identified", interim: "Mr An", successor: "Mr Nguyên", readiness: "Ready Now", site: "WNK" },
  { id: 99, incumbent: "Le Thi Tuyen", dept: "Production", role: "Production Lead Supervisor", risk: "High", status: "Successor in Development", interim: "Ms Thủy", successor: "Ms Thủy", readiness: "< 1 Year", site: "WNK" },
  { id: 100, incumbent: "Le Thi Huong", dept: "Production", role: "QP Lead Supervisor - C&S", risk: "High", status: "Ready Successor Identified", interim: "K Loan", successor: "Ms Đào", readiness: "Ready Now", site: "WNK" },
  { id: 101, incumbent: "Trinh Thi Kim Loan", dept: "Production", role: "Production Lead Supervisor", risk: "Medium", status: "Successor in Development", interim: "P Sơn", successor: "Ms Ngọc", readiness: "< 1 Year", site: "WNK" },
  { id: 102, incumbent: "Phan Thanh Son", dept: "Production", role: "Production Lead Supervisor - Cutting", risk: "Medium", status: "Successor in Development", interim: "Tuyên", successor: "Mr Nam", readiness: "< 1 Year", site: "WNK" },
  ...
  { id: 104, incumbent: "Tran Minh Thuan", dept: "Production/Management", role: "Production Manager", risk: "Medium", status: "Successor in Development", interim: "None", successor: "TRIỀU / DUY", readiness: "1-2 Years", site: "WNK" },
  { id: 105, incumbent: "Huynh Van Nhat", dept: "Production/Management", role: "Production Manager - Comp.", risk: "Medium", status: "Ready Successor Identified", interim: "None", successor: "Pham Hung Minh", readiness: "Ready Now", site: "WNK" },
  { id: 106, incumbent: "Ly Thanh Tung", dept: "Production/Management", role: "QC Assistant Manager", risk: "High", status: "Successor in Development", interim: "None", successor: "TIẾN", readiness: "1-2 Years", site: "WNK" },
  { id: 107, incumbent: "Tong Thi Sang", dept: "Production/Management", role: "Material Delivery Assistant Manager", risk: "Medium", status: "Ready Successor Identified", interim: "None", successor: "VÂN", readiness: "Ready Now", site: "WNK" },
  { id: 108, incumbent: "Duong Tri Dung", dept: "Production/Management", role: "Production Assistant Manager - Comp.", risk: "Medium", status: "No Successor Identified", interim: "None", successor: "None", readiness: "None", site: "WNK" },
  { id: 109, incumbent: "Dang Van Tan", dept: "Production/UPH", role: "Assistant Manager", risk: "High", status: "Successor in Development", interim: "GIAP QUANG HUY(Primary)", successor: "Brad Vo", readiness: "< 1 Year", site: "WNK" },
  { id: 110, incumbent: "Mai Hai Long", dept: "Production/UPH", role: "Assistant Manager", risk: "High", status: "Successor in Development", interim: "GIAP QUANG HUY(Primary)", successor: "Nguyen Minh Tung", readiness: "< 1 Year", site: "WNK" },
  { id: 111, incumbent: "Ngo Huu Chi", dept: "Production/UPH", role: "Assistant Manager", risk: "High", status: "Successor in Development", interim: "GIAP QUANG HUY(Primary)", successor: "Mark Vo", readiness: "< 1 Year", site: "WNK" },
  { id: 112, incumbent: "Thuy Do", dept: "Production/C&S", role: "Leadsupervisor", risk: "Medium", status: "Successor in Development", interim: "Bui Van Thap / Trinh Ngoc Phien (Primary)", successor: "Phan Chi Hieu", readiness: "< 1 Year", site: "WNK" },
  { id: 113, incumbent: "Bui Van Thap", dept: "Production/C&S", role: "Leadsupervisor", risk: "High", status: "Successor in Development", interim: "Trinh Ngoc Phien (Primary)", successor: "Luong Cong Thanh", readiness: "< 1 Year", site: "WNK" },
  { id: 114, incumbent: "Pham Dinh Tung", dept: "Production/C&S", role: "Supervisor", risk: "Medium", status: "Successor in Development", interim: "Trinh Ngoc Phien (Primary)", successor: "Ho Vu Binh", readiness: "< 1 Year", site: "WNK" },
  { id: 115, incumbent: "Vo Chi Tinh", dept: "Production/C&S", role: "Supervisor", risk: "Medium", status: "Successor in Development", interim: "Trinh Ngoc Phien (Primary)", successor: "Le Ba Thanh", readiness: "< 1 Year", site: "WNK" },
  ...
  { id: 119, incumbent: "Elsa Nguyen", dept: "Production/C&S", role: "QP Lead Supervisor - C&S", risk: "High", status: "Successor in Development", interim: "Dinh Van / Mai Thi Hoang Bich Tram", successor: "Do Thi Thanh Nga", readiness: "< 1 Year", site: "WNK" },
  { id: 120, incumbent: "Mai Thi Hoang Bich Tram", dept: "Production/C&S", role: "Production Lead Supervisor - C&S", risk: "High", status: "Ready Successor Identified", interim: "Dinh Van / Do Thi Thanh Nga", successor: "Do Thi Thanh Nga", readiness: "Ready Now", site: "WNK" },
  { id: 121, incumbent: "Mai Thi Loan", dept: "Production/C&S", role: "Production Lead Supervisor - C&S", risk: "High", status: "Ready Successor Identified", interim: "Dinh Van / Mai Thi Hoang Bich Tram / Do Thi Thanh Nga", successor: "Mai Thi Hoang Bich Tram / Do Thi Thanh Nga", readiness: "Ready Now", site: "WNK" },
  { id: 122, incumbent: "Do Thi Thanh Nga", dept: "Production/C&S", role: "Production Lead Supervisor - C&S", risk: "High", status: "Ready Successor Identified", interim: "Dinh Van / Mai Thi Hoang Bich Tram / Mai loan", successor: "Mai Thi Hoang Bich Tram", readiness: "Ready Now", site: "WNK" },
  ...
  { id: 125, incumbent: "Vu Van Xuan", dept: "Production", role: "Production Manager", risk: "Medium", status: "Successor in Development", interim: "David / quach", successor: "David / quach", readiness: "< 1 Year", site: "WNK" },
  { id: 126, incumbent: "Giap Quang Huy", dept: "Production", role: "Production Manager", risk: "Medium", status: "Successor in Development", interim: "None", successor: "Mai Hai Long", readiness: "< 1 Year", site: "WNK" },
  { id: 127, incumbent: "Trinh Ngoc Phien", dept: "Production", role: "Production Assistant Manager", risk: "Medium", status: "Successor in Development", interim: "Bui Van Thap", successor: "Pham Dinh Tung", readiness: "< 1 Year", site: "WNK" },
  { id: 128, incumbent: "Dinh Thi Hong Van", dept: "Production", role: "Production Assistant Manager", risk: "Medium", status: "Successor in Development", interim: "Mai Thi Hoang Bich Tram", successor: "Mai Thi Hoang Bich Tram", readiness: "< 1 Year", site: "WNK" },
  // ── ASHTON (ASH) ──────────────────────────────────────────
